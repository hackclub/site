    ...
    <main id="main" tabIndex={-1} className="opensource-page">
      <section className="opensource-hero">
        ...
        <div className="opensource-shell opensource-hero__inner">
          <div className="opensource-hero__center">
            <h1 className="opensource-hero__title">{t("heroTitle")}</h1>
            <p className="opensource-hero__lede">{t("heroLede")}</p>
            <a
      ...
      <section className="opensource-shell opensource-section">
        <div className="opensource-section__header">
          <p className="opensource-kicker opensource-kicker--dark">{t("financesKicker")}</p>
          <h2 className="opensource-section__title">{t("financesTitle")}</h2>
        </div>
      ...
      <section className="opensource-shell opensource-section opensource-section--last">
        <div className="opensource-section__header">
          <p className="opensource-kicker opensource-kicker--dark">{t("codeKicker")}</p>
          <h2 className="opensource-section__title">{t("codeTitle")}</h2>
          <p className="opensource-section__copy">{t("codeCopy")}</p>
        </div>
        <a
