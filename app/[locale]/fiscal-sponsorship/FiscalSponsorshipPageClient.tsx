...
function MobileAppSection() {
  ...
  const features = [
    {
      icon: "view",
      title: t("pocketFeatureSpendingTitle"),
      body: t("pocketFeatureSpendingBody"),
    },
    {
      icon: "bolt-circle",
      title: t("pocketFeatureTapTitle"),
      body: t("pocketFeatureTapBody"),
    },
    {
      icon: "card",
      title: t("pocketFeatureCardsTitle"),
      body: t("pocketFeatureCardsBody"),
    },
    {
      icon: "docs",
      title: t("pocketFeatureReceiptsTitle"),
      body: t("pocketFeatureReceiptsBody"),
    },
  ];
    ...
    >
      ...
      >
        <div>
          ...
          >
            {t.rich("pocketTitle", {
              primary: (chunks) => <span style={{ color: FISCAL_COLORS.primary }}>{chunks}</span>,
            })}
          </h2>
          <p
            style={{
        ...
        >
          {mobileInstalls > 0 && (
            ...
            >
              {t("installs", { count: mobileInstalls.toLocaleString() })}
            </span>
          )}
          <Image
            src="/fiscal-sponsorship/mobile-mockup.webp"
            alt={t("mobileMockupAlt")}
            loading="eager"
            width={400}
            height={800}
      ...
      >
        ...
        <div>
          ...
          >
            ...
            {t("noCardIssuingFees")}
            <br />
            {t("noSubscriptionFees")}
            <br />
            {t("noCheckDepositFees")}
            <br />
            {t("noCreditCardProcessingFees")}
          </p>
        </div>
      </div>
      ...
      <main id="main" tabIndex={-1}>
            ...
            <div>
              ...
              {referralParam && (
                ...
                >
                  ...
                  >
                    <strong>{t("referredBy")}</strong> {referralParam}
                  </p>
                </div>
              )}
        ...
        >
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            >
              <StatItem value="$100M+" label={t("statProcessed")} />
              <StatItem value="6500+" label={t("statProjects")} />
              <StatItem value="2018" label={t("statSince")} />
            </div>
        ...
        >
          ...
          >
            <a href="https://hcb.hackclub.com/applications/new">
              <button
                style={{
                  backgroundColor: "white",
                  color: "#17171d",
