...
const FEATURE_KEYS = [
  {
    icon: "bank-account",
    nameKey: "featureNonprofitName",
    bodyKey: "featureNonprofitBody",
  },
  {
    icon: "analytics",
    nameKey: "featureBalanceName",
    bodyKey: "featureBalanceBody",
  },
  {
    icon: "card",
    nameKey: "featureCardsName",
    bodyKey: "featureCardsBody",
  },
  {
    icon: "payment-transfer",
    nameKey: "featureGrantsName",
    bodyKey: "featureGrantsBody",
  },
  {
    icon: "payment-transfer",
    nameKey: "featureReimburseName",
    bodyKey: "featureReimburseBody",
  },
  {
    icon: "support",
    nameKey: "featureSupportName",
    bodyKey: "featureSupportBody",
  },
] as const;
...
function TestimonialCard({
  ...
  const t = useTranslations("HcbFirst");
...
export function FirstPageClient() {
  ...
  const heroBadges = [t("badgeNonprofit"), t("badgeGrants"), t("badgeCards")];
    ...
    <>
      ...
      <main id="main" tabIndex={-1} style={{ backgroundColor: "#0f1118" }}>
        ...
        >
          ...
          >
            <SectionHeading dark title={t("applyTitle")} body={t("applyBody")} />
