    ...
    <main id="main" tabIndex={-1} className="team-page">
      <section className="team-hero">
        ...
        <div className="team-shell team-hero__inner">
          <div className="team-hero__copy">
            ...
            <p className="team-hero__lede">{t("heroLede")}</p>
          </div>
        </div>
      ...
      <section className="team-shell board-section">
        <div className="board-section__inner">
          <h2 className="board-section__title">{t("boardTitle")}</h2>
      ...
      <section className="team-shell team-section">
        <div className="team-section__header">
          <h2 className="team-section__title">{t("coreTeamsTitle")}</h2>
          <p className="team-section__copy">{t("coreTeamsCopy")}</p>
        </div>
      ...
      <section className="team-shell team-section team-section--community">
        <div className="team-section__header">
          <p className="team-kicker team-kicker--dark">{t("communityKicker")}</p>
          <h2 className="team-section__title">{t("communityTitle")}</h2>
          <p className="team-section__copy">{t("communityCopy")}</p>
        </div>
