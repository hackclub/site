...
3. We’d be happy to send some [Hack Club stickers](https://hackclub.com/stickers) to your event. Email us <team@hackclub.com> with the name of your event, expected attendance, and the shipping address and we’ll get them in the mail.
4. Find support by joining [#hackathon-organizers](https://hackclub.slack.com/archives/C03QSGGCJN7) in our [Slack community](https://hackclub.com/slack/). You can ask questions and talk to 500+ hackathon organizers from all over. Or, read [a guide to organizing your hackathon](https://expandables.hackclub.dev/organizing.html) from another teen organizer.
