...
padding: ["24px", "32px"],
    ...
    >
      ...
      <Text style={{textAlign: "center", width: "100%", display: "flex", justifyContent: "center", marginBottom: "32px"}}>Need help getting your Pizza Grant? Email <Link href="mailto:holly@hackclub.com" style={{marginLeft: 6}}>holly@hackclub.com</Link></Text>
