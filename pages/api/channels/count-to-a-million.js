export default async (req, res) => {
  ...
  const history = await fetch(`https://slack.com/api/conversations.history?token=xoxb-2210535565-1183214108356-LhKMNc402ep8EyXYO7OHzVdP&channel=CDJMS683D&limit=1&inclusive=true`)
    .then(r => r.json())
