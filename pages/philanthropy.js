...
const Highlight = ({children}) => {
  return(
    <Text sx={{color: '#ec3750'}}>{children}</Text>
  )
}
const Line = () => {
  return (
...
const delimiterIconStyles = {
  ...
  borderRadius: 'none',
  backgroundImage:
    'url(https://icons.hackclub.com/api/icons/0xED3851/glyph:view-fill.svg)'
}
const Map = () => {
  return (
    <Fade bottom>
    ...
    <>
      ...
      <Box
        sx={{
          ...
          alignItems: 'center',
          backgroundImage:
            'linear-gradient(to bottom,rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(https://cloud-1946czd4l-hack-club-bot.vercel.app/0hackpenn_1__1_.jpg)',
          backgroundSize: 'cover',
          backgroundPosition: 'top center'
        }}
      >
      ...
      >
        <Fade bottom>
          ...
          >
            <Text as="h1">
              <Quote>“</Quote>With major support, I am confident Hack Club will
              change the world.<Quote>”</Quote>
            </Text>
            <Text as="p" sx={{color: 'muted'}}>—Tom Preston-Werner, GitHub Co-founder</Text>
          </Box>
        </Fade>
        <Line />
        <br />
        ...
        <Fade bottom>
          <Text as="p">
            ...
            most iconic creators, Hack Club already reaches tens of thousands of
            teenagers, and represents the largest network of technical teens in
            the world. Each day, new projects are shipped, new lines of code are
            written, and new friendships are forged through collaborative,
        ...
        <Fade bottom>
          <Text as="p">
            ...
            free computer science education, a hacker mindset, and an equal shot
            at success to every teenager, regardless of where they’re from, how
            they identify, or what their parents do.
          </Text>
        </Fade>
        </Container>
        <Box
            ...
            <Container sx={{ textAlign: 'center' }}>
              ...
              <Grid my="4" gap={2} columns={[1, 1, 2]}>
                ...
                >
                  ...
                  >
                    8k+ projects shipped by Hack Clubbers
                  </Heading>
                  <Posts data={posts} />
                </Box>
              </Grid>
              ...
              <Text sx={{display: 'inline-flex', alignItems: 'center', gap: 2}}><Image src="/philanthropy/belle.png" width="20" height="20" sx={{borderRadius: '100%'}} />Belle, 17, Malaysia</Text>
            </Container>
          </Fade>
        </Box>
        <Container
      ...
      >
        <Fade bottom>
          <Text as="h1" my={4} sx={{color: '#ec3750'}}>
            As thelargest network of technical teenagers, we are featured in
            the news:
          </Text>
        ...
        <Grid gap={4} columns={[1, '1fr 2fr', '1fr 2fr']} mt={2}>
          <Box>
            ...
            <Fade bottom delay={600}>
              ...
              <Box>
                ...
                <Text as="p">Founder, Source Graph</Text>
              </Box>
            </Fade>
          ...
          <Fade bottom delay={900}>
            <Box sx={{ color: 'muted' }}>
              <Text as="p">
              <Quote>“</Quote>Hack Club is the organization I wish I had when I was a
                teenager.
              </Text>
              <br />
              <Text as="p">
              ...
              <Text as="p">
                ...
                involved for the long term. I also personally intend to continue
                and grow my financial support of their mission.<Quote>”</Quote>
              </Text>
              <br />
              <Text as="p">
          ...
          <Grid gap={2} columns={[2, 4, 4]} mt={2}>
            <Box>
              <Fade bottom delay={50}>
                <Text as="h3">Above $2 Million</Text>
              </Fade>
          ...
          <Fade bottom delay={100}>
            ...
            >
              ...
              <Text as="p">
                ...
                year of high school at Kabulonga Boys' Secondary School, and now
                more than a dozen students are coding.
              </Text>
              <br />
              <Text as="p">
                Thanks to our donor-funded laptop program, Hack Club sent him a
                MacBook Air 2020. In his Hack Club, Obrey and his best friend
          ...
          <Fade bottom delay={200}>
            ...
            >
              ...
              <Text as="p">
                ...
                quality computer science classes so she learned to code at Hack
                Club.
              </Text>
              <br />
              <Text as="p">
                At 16, she started her own club Hack Club where 20 other
                students joined and even raised $12k to run a hackathon and camp
                for hundreds more. Megan is now a sophomore at Harvard
                University.{' '}
              </Text>
            </Box>
          </Fade>
        ...
        <Fade bottom>
          <Text
            as="h1"
            sx={{ textAlign: 'center', maxWidth: '950px', mx: 'auto', color: '#ec3750' }}
            mb={4}
          >
            In the next ten years, Hack Club will discover, foster and inspire
            thousands more teenagers to become highly technical.
          </Text>
        </Fade>
        <Fade bottom>
          <Text as="p">
        ...
        <Fade bottom>
          <Text as="h1" sx={{ textAlign: 'center' }} mb={4}>
            Hack Club invites the 21st century’s leading thinkers, builders and
            disrupters to join our small, core network of donors with a gift.
          </Text>
          <Text as="p">
            ...
            demand. With your gift, Hack Club could increase engineering support
            to serve thousands more teenagers, with a strong focus on serving
            those who face additional barriers to contributing their talents to
            the world.
          </Text>
        </Fade>
        <br />
        ...
        <ul>
          ...
          <Fade bottom delay={240}>
            <li>
              Extend mini-grants of hardware and internet access to hundreds of
              teenagers
            </li>
          </Fade>
          <Fade bottom delay={270}>
        ...
        <Fade bottom>
          <Button as="a" href="/philanthropy/hackclub.pdf" download="HackClub" mb={4}>Download as PDF</Button>
        </Fade>
      </Container>
      <Footer />
      </Box>
