import { Avatar, BaseStyles, Box, Button, Card, Container, Flex, Grid, Heading, Link, Text } from 'theme-ui';
...
const PhotoRow = ({ photos }) => (
	<Box sx={{ height: '160px', overflow: 'hidden' }}>
		<Box sx={{ display: ['block', 'block', 'block', 'block', 'none'] }}>
			<Marquee velocity={12}>
				{photos.map((photo, index) => (
					<Image placeholder="blur" src={photo} objectFit="cover" className="next-image" height="200px" width="300px" alt="Hack Club students" key={'image-' + index} />
				))}
			</Marquee>
		</Box>
		<Box sx={{ display: ['none', 'none', 'none', 'none', 'block'] }}>
			<Marquee velocity={12}>
				{photos.map((photo, index) => (
					<Image placeholder="blur" src={photo} objectFit="cover" className="next-image" height="200px" width="600px" key={'image-' + index} alt="Hack Club students" />
				))}
			</Marquee>
		</Box>
	</Box>
	...
	return (
		<>
			<Box sx={{ my: 'auto' }}>
				...
				<ResponsiveContainer width="90%" height="100%" minHeight="350px" sx={{ mx: 'auto', my: '5%', overflow: 'visible' }}>
					<BarChart
						data={data}
						animationBegin={1000}
						sx={{
...
const Map = () => {
	return (
		<Fade bottom>
			...
			>
				<ReactBeforeSliderComponent firstImage={FIRST_IMAGE} secondImage={SECOND_IMAGE} delimiterIconStyles={delimiterIconStyles} currentPercentPosition={30} />
				<Text variant="caption">What Hack Club could look like with your support</Text>
			</Box>
		</Fade>
	);
};
...
const Philanthropy = ({ posts = [] }) => {
	return (
		<>
			<Meta as={Head} title="Philanthropy" description="Support Hack Club" image="https://workshop-cards.hackclub.com/Philanthropy.png?theme=light&md=1&fontSize=250px&caption=&images=" />
              ...
              >
					...
					>
						...
						>
							<Container sx={{ maxWidth: '48rem' }}>
								...
								<Button variant="ctaLg" my={3} sx={{ width: ['100%', 'auto'] }} as="a" href="https://bank.hackclub.com/donations/start/hq">
									Donate
									<Text sx={{ display: ['none', 'inline-block'], ml: 2 }}>to Hack Club</Text>
								</Button>
				...
				>
					<Fade bottom delay={60}>
						...
						>
							<Text as="h1">
								<Quote>“</Quote>With major support, I am confident Hack Club will change the world.<Quote>”</Quote>
							</Text>
					...
					<Fade bottom>
						<Grid gap={[4, 2, 2]} columns={[1, '1r 1fr', '1fr 1fr']} mt={2}>
							...
							<Box>
								...
								<Text as="p">8605 Santa Monica Blvd #86294, West Hollywood, CA, 90069</Text>
								...
								<Text>We also accept crypto, stocks, and other forms of support.</Text>
							</Box>
						</Grid>
					</Fade>
					<Line />
					<Fade bottom delay={100}>
						...
						<span>Starting in 2021, Hack Club has engaged with an external auditing firm and has audited financials through the current fiscal year.</span>
					</Fade>
				...
				>
					<Container sx={{ textAlign: 'center' }}>
						...
						<Grid my="4" gap={2} columns={[1, 1, 1, 2]}>
							...
							>
								<Fade bottom delay={90}>
									<Stat num="11 million" words="messages sent" background="https://icons.hackclub.com/api/icons/0xFAFAFA/glyph:slack.svg" />
								</Fade>
								<Fade bottom delay={120}>
									<Stat num="400" words="Hack Clubs around the world" background="https://icons.hackclub.com/api/icons/0xFAFAFA/glyph:event-code.svg" />
								</Fade>
								<Fade bottom delay={150}>
									<Stat num="500" words="nonprofits supported" background="https://icons.hackclub.com/api/icons/0xFAFAFA/glyph:member-add.svg" />
								</Fade>
								<Fade bottom delay={180}>
									<Stat num="100+" words="global events" background="https://icons.hackclub.com/api/icons/0xFAFAFA/glyph:profile.svg" />
								</Fade>
								<Fade bottom delay={180}>
									<Stat num="4" words="life changing summers" background="https://icons.hackclub.com/api/icons/0xFAFAFA/glyph:photo.svg" />
								</Fade>
							</Box>
						</Grid>
						<Fade delay={210} bottom>
							<Text as="h2">“Hack Club helped me fall in love with creating and made me feel like I belong.”</Text>
							<Text sx={{ display: 'inline-flex', alignItems: 'center', gap: 2 }}>
								<Image src="/philanthropy/belle.png" width="20" height="20" sx={{ borderRadius: '100%' }} />
								Belle, 17, Malaysia
							</Text>
						</Fade>
					</Container>
				...
				>
					<Fade bottom>
						...
						<Grid gap={[0, 0, 4]} columns={['1fr 1fr', '1fr 0.5fr 1fr 1fr']}>
							<Link href="https://www.businessinsider.com/zach-lattas-hacker-club-got-him-on-forbes-30-under-30-2016-1" target="_blank" sx={{ display: 'flex', alignItems: 'center' }}>
								<Image src="/philanthropy/insider-logo.svg" width={530} height={150} />
							</Link>
							<Link href="https://www.wsj.com/articles/teen-hackers-try-to-convince-parents-they-are-up-to-good-11569922200" target="_blank" sx={{ display: 'flex', alignItems: 'center' }}>
								<Image src="/philanthropy/wsj-logo.svg" width={270} height={100} />
							</Link>
							<Link href="https://www.forbes.com/sites/fastforward/2021/06/29/from-journalism-to-a-tech-nonprofit-this-coos-big-pivot-to-empower-the-next-generation-of-coders/" target="_blank" sx={{ display: 'flex', alignItems: 'center' }}>
								<Image src="/philanthropy/forbes-logo.svg" width={500} height={100} />
							</Link>
							<Link href="https://www.philanthropy.com/article/nonprofits-need-to-embrace-transparency-even-if-the-supreme-court-rules-to-protect-donor-privacy" target="_blank" sx={{ display: 'flex', alignItems: 'center' }}>
					...
					<Grid gap={4} columns={[1, '1fr 2fr', '1fr 2fr']} mt={2}>
						<Box>
								...
								<Box>
									<Box sx={{ display: 'flex', alignItems: 'center' }}>
										...
										<Box>
											...
											<Text as="p" sx={{ lineHeight: '1em', fontSize: '1.1em !important' }}>
							...
							<Fade bottom delay={800}>
								<br />
								<Text sx={{ color: 'muted', fontSize: '90%' }}>Board advisor: John Abele (Founder, Boston Scientific)</Text>
							</Fade>
						</Box>
						<Fade bottom delay={900}>
							<Box sx={{ color: 'muted' }}>
								<Text as="p">
									<Quote>“</Quote>Hack Club is the organization I wish I had when I was a teenager.
								</Text>
								<br />
								<Text as="p">In 2017, I joined as a founding board member, and I’ve seen firsthand the leadership team act with integrity and transparency since Day 1. Founder Zach Latta and COO Christina Asquith are efficient, responsible and disciplined stewards of every dollar, and I've proudly grown my donations over the years.</Text>
								<br />
								<Text as="p">
								...
								<br />
								<Text as="p">— Tom Preston-Werner, Co-founder, Preston-Werner Ventures / Co-founder and former CEO, GitHub</Text>
							</Box>
						</Fade>
					</Grid>
					<Line />
					...
					<Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }} mb={5}>
						<Fade bottom delay={30}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/0figma.png" name="Dylan Field, Founder, Figma" />
						</Fade>
						<Fade bottom delay={60}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/1vercel.png" name="Guillermo Rauch, Founder, Vercel" />
						</Fade>
						<Fade bottom delay={90}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/7laravel.png" name="Taylor Otwell, Creator of Laravel" />
						</Fade>
						<Fade bottom delay={120}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/5sequoia.png" name="Andrew Reed, Partner, Sequoia" />
						</Fade>
						<Fade bottom delay={150}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/6replit.png" name="Amjad Masad, Co-founder, Replit" />
						</Fade>
						<Fade bottom delay={180}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/2workflow.png" name="Conrad Kramer, Co-founder, Workflow" />
						</Fade>
						<Fade bottom delay={210}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/3github.png" name="Tim Clem, Senior Engineer, GitHub" />
						</Fade>
						<Fade bottom delay={240}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/4sentry.png" name="David Cramer, Co-founder, Sentry" />
						</Fade>
						<Fade bottom delay={270}>
							<Pill logo="https://cloud-kwnsazl2x-hack-club-bot.vercel.app/8vgs.png" name="Mahmoud Abdelkader, CEO, Very Good Security" />
						</Fade>
						<Fade bottom delay={270}>
					...
					<Grid gap={3} columns={[1, 1, 1, 2]} mt={2} mb={4}>
						<Fade bottom delay={100}>
							<Q>
								...
								<Heading fontSize={[4, 5]} sx={{ fontWeight: '700', fontSize: ['18px', '20px', '22px'] }}>
								...
								<Flex align="center" mt={[3, 4]}>
									<Avatar src="/philanthropy/obrey.png" sx={{ height: '48px', width: '48px' }} mr={3} st />
						...
						<Fade bottom delay={200}>
							<Q>
								...
								<Flex align="center" mt={[3, 4]}>
									<Avatar src="/philanthropy/maggie.png" sx={{ height: '48px', width: '48px' }} mr={3} st />
									<Box align="left" fontSize={3}>
					...
					<Grid columns={['1fr', '1fr', '1fr', '0.8fr 1.2fr']}>
						<Fade bottom>
							<Box>
								<Text as="p">We envision thousands of diverse Hack Club leaders in towns and cities across America and the world, connected online, and self-organizing events and hackathons–driven by a can-do culture and a rigorous dedication to building real things in the real world.</Text>
								<br />
								<Text as="p">Founded in 2014, Hack Club grew 700 percent during the COVID-19 pandemic, and Hack Club’s team of engineers can’t keep up with demand.</Text>
							</Box>
						</Fade>
						<Map />
					</Grid>
					...
					<ul>
						<Fade bottom>
							<li>Increase support to serve thousands more teenagers, with a strong focus on serving those who face additional barriers to contributing their talents to the world</li>
						</Fade>
						<Fade bottom delay={30}>
							<li>Create hundreds more Hack Clubs in high schools and communities across the country and world</li>
						</Fade>
						<Fade bottom delay={60}>
							<li>Inspire a problem-solving mindset and a hacker identity, where teenagers are empowered to build what they want to see in the world</li>
						</Fade>
						<Fade bottom delay={90}>
							<li>Make Hack Club the best place to be a teenager on the internet, incentivizing a shift among teenagers from consumers to creators of technology</li>
						</Fade>
						<Fade bottom delay={120}>
							<li>Launch special projects, in which Hack Clubbers collaborate with SpaceX, Vercel, Cloudflare, Replit, Dogecoin and others</li>
						</Fade>
						<Fade bottom delay={150}>
							<li>Popularize transparent accounting, open source building, and high-integrity leadership</li>
						</Fade>
						<Fade bottom delay={180}>
							<li>Grow the team, mostly engineers</li>
						</Fade>
						<Fade bottom delay={210}>
							<li>Host dozens of in-person events, including our summer adventure</li>
						</Fade>
						<Fade bottom delay={240}>
							<li>Extend mini-grants of hardware and internet access to hundreds of teenagers</li>
						</Fade>
						<Fade bottom delay={270}>
							<li>Bring computer science and engineering skills to thousands more teenagers</li>
						</Fade>
					</ul>
					<Box my={4}>
						<Fade bottom delay={350}>
						...
						<Flex mb={4}>
							<Fade bottom delay={410}>
								<Box sx={{ marginRight: 3 }}>
									<Image src="/philanthropy/christina-s.png" width={250} height={100} />
									<Text as="p">Christina Asquith, Co-founder and COO</Text>
								</Box>
							</Fade>
							<Fade bottom delay={440}>
								<Box>
									<Image src="/philanthropy/zach-s.png" width={150} height={100} />
					...
					<Fade bottom delay={200}>
						<Grid gap={4} columns={[1, '2fr 1fr', '2fr 1fr']} my={4} sx={{ color: 'muted' }}>
							<Box>
					...
					<Fade bottom>
						<Button as="a" href="/philanthropy/hackclub.pdf" download="HackClub" mb={4} sx={{ fontSize: '1em !important' }}>
							Download as PDF
						</Button>
					</Fade>
					<Fade bottom>
