      ...
      <div className={styles.footer_wrapper}>
        <div className={styles.footer_information}>
          ...
          <p>
            ...
            Thank you:
            <a href="https://awdev.codes" target="_blank">
              Aaron Wong
            </a>
            ,
            <a href="https://github.com/kvnyng" target="_blank">
              Kevin Yang
            </a>
            ,
            ...
            ,
            <a href="https://github.com/24c02" target="_blank">
              Nora
            </a>
            ,
            <a href="https://maxwofford.com" target="_blank">
              Max Wofford
            </a>
            , &{' '}
          ...
          <div className={styles.footer_links_column}>
            ...
            <div className={styles.footer_icons_container}>
              ...
              >
                ...
                >
                  <g>
                    <path d="M16.774 14.114c-.5.5-.78 1.179-.78 1.886v-2.667h2.666c-.707 0-1.386.281-1.886.781z"></path>
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
              ...
              >
                ...
                >
                  <g>
                    ...
                    ></path>
                    <path d="M16 9.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 1 0 0-12.324zM16 20a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm7.845-10.405a1.44 1.44 0 1 1-2.88 0 1.44 1.44 0 0 1 2.88 0z"></path>
                  </g>
                </svg>
              </a>
              <a
            ...
            <span>
              <a href="tel:1-855-625-HACK" className={styles.footer_tel}>
                1-855-625-HACK
              </a>
        ...
        <p className={styles.footer_cr_info}>
