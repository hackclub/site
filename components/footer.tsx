...
import { Box, Container, Image, Grid, Heading, Link, Text, ThemeUIStyleObject } from 'theme-ui'
...
interface ServiceProps extends React.ComponentPropsWithoutRef<typeof Link> {
    icon: string
    name?: string
}

const Service: React.FC<ServiceProps> = ({ href, icon, name = '', ...props }) => (
    <Link
        target="_blank"
        rel="noopener me"
        href={href}
