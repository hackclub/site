...
const Logo = props => (
	<svg xmlns="http://www.w3.org/2000/svg" width="256" height="90" fill="#8492A6" viewBox="0 0 256 90" {...props}>
...
const Service = ({ href, icon, name = '', ...props }) => (
	<Link target="_blank" rel="noopener" href={href} title={`Hack Club on ${name ? name : icon}`} {...props}>
		<Icon glyph={icon} />
	</Link>
);

const Footer = ({ dark = false, children, ...props }) => (
	<Base color={dark ? 'muted' : 'slate'} py={[4, 5]} dark={dark} sx={{ textAlign: 'left' }} as="footer" {...props}>
			...
			>
				...
				<Box sx={{ gridColumn: ['span 2', 'span 1'] }}>
					...
					>
						...
						<Service href="https://www.facebook.com/Hack-Club-741805665870458" icon="facebook" name="Facebook" />
						<Service href="https://www.youtube.com/c/HackClubHQ" icon="youtube" name="YouTube" />
						<Service href="https://www.instagram.com/starthackclub" icon="instagram" name="Instagram" />
