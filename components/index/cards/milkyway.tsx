    ...
    <Box sx={{ position: 'relative', my: [4, 4] }}>
      ...
      <CardModel
        ...
        sx={{
          ...
          textAlign: 'center',
          backgroundImage:
            'url(https://cdn.hackclub.com/019c76ba-4bf9-7fa7-ad67-86c4e0396b12/3ubjSQ.png)',
      ...
      >
        ...
        >
          <Box sx={{ mt: 220 }}>
            ...
            >
              Make games, build houses, and get prizes like <br /> a flight to a
              game jam in Singapore!
            </Text>
          </Box>
