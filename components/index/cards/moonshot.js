  ...
  return (
    <Box sx={{ position: 'relative', my: [4, 4] }}>
      ...
      >
        <Box
          as="img"
          src="https://cdn.hackclub.com/019c76b8-ce4f-71e6-9b6a-5f5a83820ab4/qvrPmQ.png"
          alt="Moonshot Cat"
          sx={{
      ...
      >
        <Box
          as="img"
          src="https://cdn.hackclub.com/019c76b9-a9fb-7007-8ece-a9b80db1adc2/wAhHCw.png"
          alt="Orpheus"
          sx={{
      ...
      <CardModel
        ...
        sx={{
          ...
          overflow: 'hidden',
          textAlign: 'center',
          backgroundImage: "url(https://cdn.hackclub.com/019c76b5-a0d6-71f9-9542-2835fd158b1b/nEhr-g.png)",
      ...
      >
        <Box sx={{ mb: 3, textAlign: 'center' }}>
          <Image
            src="https://cdn.hackclub.com/019c76ba-577f-7fa5-9479-7decc43d1f62/J52lAw.png"
            alt="moonshot!"
            sx={{
