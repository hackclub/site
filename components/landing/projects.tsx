...
function ProjectCard({ project }: { project: AirtableProject }) {
  const { projectName, person, age, country, imageUrl, programName, playableUrl, codeUrl } = project;
  return (
    <div
      style={{
        flexShrink: 0,
    ...
    >
      {/* Project screenshot */}
      <div style={{ width: "100%", height: 200, overflow: "hidden", flexShrink: 0, background: "#e0e6ed" }}>
        <Image
          src={imageUrl ?? "https://cdn.hackclub.com/019db857-86e4-716f-b274-7aa4c975fa67/projectCardPhoto.webp"}
          alt={projectName}
          width={290}
          height={200}
      ...
      <div style={{ padding: "16px 18px 18px", flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        >
          <strong>{person}</strong>{age ? ` (${age})` : ""}{country ? ` from ${country}` : ""} made{" "}
          <strong>{projectName}</strong>{programName ? ` for Hack Club ${programName}` : ""}.
        </p>
        <div style={{ display: "flex", alignItems: "flex-end", gap: 8 }}>
          {playableUrl && (
            ...
            >
              Try it out <span className="btn-arrow">→</span>
            </a>
          )}
          {codeUrl && (
            <a
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 5, marginBottom: 24, overflow: "hidden" }}>
        {/* Edge fade overlays */}
        <div className="carousel-fade-left" style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: 120, background: "linear-gradient(90deg, #f9fafc 0%, transparent 100%)", zIndex: 2, pointerEvents: "none" }} />
        <div className="carousel-fade-right" style={{ position: "absolute", right: 0, top: 0, bottom: 0, width: 120, background: "linear-gradient(270deg, #f9fafc 0%, transparent 100%)", zIndex: 2, pointerEvents: "none" }} />
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
          ...
          >
            ...
            />
            <svg className="pause-icon" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true">
              <line x1="8" y1="6" x2="8" y2="18" stroke="currentColor" strokeWidth="3.6" strokeLinecap="round" />
              <line x1="16" y1="6" x2="16" y2="18" stroke="currentColor" strokeWidth="3.6" strokeLinecap="round" />
            </svg>
            <svg className="play-icon" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true">
              <path d="M8 6 Q8 5 9 5 L16.5 9.9 Q17.8 10.8 17.8 12 Q17.8 13.2 16.5 14.1 L9 19 Q8 19 8 18 Z" fill="currentColor" />
            </svg>
          </label>
        </div>
      </div>
      ...
      >
        ...
        <svg
          ...
          style={{ width: "100%", height: 22, display: "block", position: "absolute", top: 24, left: 0 }}
