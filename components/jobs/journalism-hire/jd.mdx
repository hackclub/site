...
Right now, I'm working with a Silicon-Valley-based non-profit, **[Hack Club](https://hackclub.com)** that represents the largest network of teen coders in the world. Our mission is to support a new generation of young people who build, innovate and solve with computers.  I'm looking to hire a talented reporter/editor to partner with me to steadily produce journalism on education and technology, which would be published in a variety of different outlets, from op-eds, to blogs, to Clubhouse conversations. We are a non-partisan, 501c3 non-profit.
 
This person must have a dedicated track record of publishing reported articles, features and op-ed/essays; pitching editors, and turning around copy quickly. They should be sharp, clear thinkers, dogged reporters, and be able to see stories and understand news hooks. Multimedia experience would also be a plus, including simple video editing, social media, design.

We have a compelling bucket of story ideas that we'd like to execute on.  

-minimum 5-10 years experience; a more experienced editor could join on contract 
-dozens of published pieces, with some top tier outlets
-ability to turn copy around quickly
-understanding of how to match a piece with an outlet
-ability to deeply report- including calling people 
-do some producing of events, including setting up events on Clubhouse, panels and Ask-Me-Anything 
-has media contacts
...
To apply, please email us at journalist.editor@hackclub.com with “hack the planet” in the subject line. We don’t think we’ll be able to identify this person by looking at resume alone, so please include 300-400 words on your background relative to this role and why you’re interested.
