...
When we started HCB, it was being developed in private. Over time, we’ve being welcoming more Hack Clubbers onto the codebase. Last spring, we mentored six Hack Clubber one-on-one as part of “Mentorship”. That helped us prepare the repository for new contributors. And, now, we’re ready to make the repository public!

Check it out: ~[github.com/hackclub/hcb](http://github.com/hackclub/hcb)~.
...
At the same time, this is an opportunity for every HCB user to contribute towards making HCB a better platform. We’ve set up a guide to getting started with HCB, and we’re always happy to help (reach out to ~[hcb-engr@hackclub.com](mailto:hcb-engr@hackclub.com)~).
