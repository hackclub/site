...
const LadderScene = ({ width = 380, height = 250 }) => {
  ...
  useEffect(() => {
    ...
    rc.rectangle(giverX - 45, giverY, blockSize, blockSize, { stroke: 'white' })
  ...
  return (
    <div className="relative w-full flex justify-center items-center">
      <Logo
        ...
        width={128}
        height={35}
        className="absolute left-[1000px] top-[10px]" // tweak these values to match flag position
      />
